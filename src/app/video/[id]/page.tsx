...
const videoData = [
  ...
  },
  {
    id: 2,
    title: "Kanye West",
    description: "A documentary about Kanye West.",
    videoUrl: "https://player.vimeo.com/video/76979871",
  },
  {
    id: 3,
    title: "Lion King",
    description: "A documentary on lions.",
    videoUrl: "https://player.vimeo.com/video/76979871",
  },
  {
    id: 0,
...
const VideoPage = () => {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between px-24 pb-24 bg-black text-white">
      {/* Header */}
      <header className="w-full flex items-center py-12 px-8">
        {/* Icon Area */}
        <div className="mr-4">
          <Image
            src="/favicon.ico"
        ...
        <h1 className="text-5xl font-extrabold flex-1 text-center ml-20">
          {video.title}
        </h1>
        ...
        >
          <HomeIcon className="mr-2" /> {/* Material UI Home Icon */}
          Homepage
        </a>
      </header>
      ...
      <section className="w-full max-w-7xl flex flex-col items-center mt-12">
        ...
        <div
          className="video-container flex flex-col items-center p-8 w-full"
